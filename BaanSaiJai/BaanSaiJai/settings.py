"""
Django settings for BaanSaiJai project.
...
WSGI_APPLICATION = 'BaanSaiJai.wsgi.application'
...
MEDIA_URL = '/media/'
# กำหนดโฟลเดอร์สำหรับเก็บไฟล์สื่อ (media files)
